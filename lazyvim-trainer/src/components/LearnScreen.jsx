...
import { bg, sf, sf2, ac, t1, t2, t3, mono, page, container, kbd, backBtn, sectionLabel, divider } from "../constants/theme";
  ...
  return (
    <div style={page}>
      <div style={container}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div>
              ...
              <p style={{ color: t2, fontSize: 13, margin: "4px 0 0" }}>{questions.length} keybindings to learn</p>
            </div>
          </div>
        ...
        <div style={sectionLabel}>Keybinding Reference</div>
